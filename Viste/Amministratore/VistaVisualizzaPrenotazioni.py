...
class VistaVisualizzaPrenotazioni(QWidget):
    ...
    def __init__(self, parent = None):
        super(VistaVisualizzaPrenotazioni, self).__init__(parent)
        ...
        self.resize(400, 200)
        self.setWindowTitle("Visualizza Prenotazioni")
    ...
    def load_prenotazioni(self):
        ...
        for prenotazione in prenotazioni.values():
            item = QStandardItem()
            nome = f"{prenotazione.nome} {prenotazione.dataOra} - {prenotazione.numeroPersone}  {prenotazione.stampaTavoliAssociati()}"
            item.setText(nome)
