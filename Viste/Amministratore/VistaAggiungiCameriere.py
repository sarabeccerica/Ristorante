...
class VistaAggiungiCameriere(QWidget):
    def __init__(self,parent = None):
        super(VistaAggiungiCameriere, self).__init__(parent)
        ...
        btn_ok.clicked.connect(self.aggiungiCameriere)
    ...
    def aggiungiCameriere(self):
        ...
        try:
            ...
            cameriere.aggiungiCameriere(nome,cognome,dataNscita,codiceFiscale,indirizzoEmail,password,telefono)
        except:
